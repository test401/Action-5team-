...
<body>
	<div class="boardpage">
		<form name="writeForm" action="/Action/AuctionBoard?action=update&pageNumber=${currentPageNumber}&boardNum=${auctionBoard.boardNum}&searchType=${param.searchType}&searchText=${param.searchText}" method="POST">
			...
			<div class="buttonbar">
				...
				<input type="button" value="취소" onclick="goUrl('/Action/AuctionBoard?action=read&pageNumber=${currentPageNumber}&boardNum=${freeBoard.boardNum}&searchType=${param.searchType}&searchText=${param.searchText}');">
			</div>
		</form>
	</div>
</body>
