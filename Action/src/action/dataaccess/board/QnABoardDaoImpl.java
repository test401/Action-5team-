...
public class QnABoardDaoImpl implements QnABoardDao {
	 ...
	 */
	@Override
	public List<QnABoard> selectBoardList(Map<String, Object> searchInfo) {
		...
		String query = "SELECT * FROM " 
				+ "(SELECT ROWNUM r, boardnum, title, memberID FROM "
				+ "(SELECT boardnum, title, memberID, contents FROM QnABoard "
				+ whereSQL + " ORDER BY boardnum DESC)) WHERE r BETWEEN ? and ?";
	...
	public int selectBoardCount(Map<String, Object> searchInfo) {
		...
		String query = "SELECT count(boardnum) FROM QnABoard " + whereSQL;
	 ...
	 */
	@Override
	public QnABoard selectBoard(int num) {
		QnABoard board = null;

		String query = "SELECT * FROM QnABoard WHERE boardnum = ?";
	...
	public void insertBoard(QnABoard board) {
		String query = "INSERT INTO QnABoard (boardnum, title, memberID, contents "
	...
	public void updateBoard(QnABoard board) {
		String query="UPDATE QnABoard SET title=?, contents=? WHERE boardnum=?";
