...
public class Board {
	...
	/**1. 경매목록 테이블 */
	public Board(String boardNum, String memberID, int listNum) {
		super();
	...
	/**2. 카테고리 테이블 */
	public Board(int categoryID, String categoryName) {
		super();
	...
	/**3. 경매 게시판 테이블 */
	public Board(String boardNum, String title, String writer, String image,
			BLOB contents, Date startTime, Date endTiem, int isImmediately,
	...
	/**4. 입찰 목록 테이블 */
	public Board(String boardNum, String memberID, int currentPrice, int bidNum) {
		super();
		this.bidNum = bidNum;
		this.boardNum = boardNum;
		this.memberID = memberID;
	...
	/**5. 경매 게시판 댓글 테이블 */
	public Board(String boardNum, String writer, int replyNum, int masterNum,
	...
	/**6. 문의 게시판 테이블 */
	public Board(String boardNum, String title, String writer, String content) {
		super();
		this.boardNum = boardNum;
		this.title = title;
		this.writer = writer;
	...
	/**7. 문의 게시판 답글 테이블 */
	public Board(String boardNum, String writer, String content, int replyNum) {
		super();
		this.replyNum = replyNum;
		this.boardNum = boardNum;
		this.content = content;
