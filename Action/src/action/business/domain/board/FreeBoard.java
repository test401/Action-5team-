...
public class FreeBoard extends Board{
	...
	//게시판 상세 조회
	public FreeBoard(int boardNum, String title, String memberID, String contents, int isNotice) {
		super(boardNum, title, memberID, contents);
		this.isNotice = isNotice;
	}
	
	//게시글 작성
	public FreeBoard(String title, String memberID, String contents, int isNotice) {
