...
import action.dataaccess.board.FreeBoardDaoImpl;
import action.business.domain.board.FreeBoard;
import action.business.service.DataNotFoundException;

public class FreeBoardServiceImpl implements FreeBoardService {
	
	private FreeBoardDao boardDaoAccess;

	public FreeBoardServiceImpl(){
		boardDaoAccess = new FreeBoardDaoImpl();
	}

	@Override
	public FreeBoard findBoard(int num) throws DataNotFoundException {
	 ...
	 */
	@Override
	public FreeBoard[] getBoardList(Map<String, Object> searchInfo) {		
		return boardDaoAccess.selectBoardList(searchInfo).toArray(new FreeBoard[0]);
	}
	 ...
	 */
	@Override
	public void writeBoard(FreeBoard board) {
	 ...
	 */
	@Override
	public void updateBoard(FreeBoard board) throws DataNotFoundException {
