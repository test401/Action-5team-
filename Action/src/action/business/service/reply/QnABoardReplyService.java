...
public interface QnABoardReplyService {
     ...
     * @return 검색된 댓글 정보를 담고 있는 QnABoardReply 객체
     ...
     * @return 검색된 모든 댓글 정보를 담고 있는 QnABoardReply 배열
     */
     ...
     * 새로운 댓글을 등록한다.
     *
     * @param reply 등록할 댓글 정보를 담고 있는 QnABoardReply 객체
     */
     ...
     * 기존 댓글을 수정한다.
     *
     * @param reply 수정할 댓글 정보를 담고 있는 QnABoardReply 객체
